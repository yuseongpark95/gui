...
public class PizzaOrder_mine extends JFrame implements ItemListener,ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PizzaOrder_mine frame = new PizzaOrder_mine();
	...
	public PizzaOrder_mine() {
		...
		//피자 아이콘
		URL imgURL = getClass().getResource("yummy.png");
		...
		panel_3.setForeground(new Color(220, 20, 60));
		...
		panel_4.setForeground(new Color(220, 20, 60));
	...
	public void actionPerformed(ActionEvent e) {
		lblPay.setText(e.getActionCommand() + " ");
